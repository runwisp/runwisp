...
-- execution_id identifies a station-dispatched run and is used as a lookup key
...
-- (non-station) runs leave execution_id NULL and are excluded by the predicate.
