...
func (u *unsupportedInstaller) EnsurePasswordDropIn(_ context.Context, _ InstallOptions, _ string) (string, bool, error) {
	return "", false, ErrUnsupported
}

func (u *unsupportedInstaller) SupportsPasswordDropIn() bool {
	return false
}

func (u *unsupportedInstaller) WriteEnvDropIn(_ context.Context, _ InstallOptions, _ string, _ map[string]string) (string, DropInChange, error) {
	return "", DropInUnchanged, ErrUnsupported
}
