...
| Row key         | What it is                                                                                                                   |
| --------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `jwt_secret`    | 32-byte HMAC key for [JWT signing](/operations/auth/#the-session-token). Generated on first boot.                            |
...
2. **Open the database.** Creates `runwisp.db`, runs the schema, sets
...
[boot-semantics]: /concepts/scheduling/#boot-semantics-in-flight-runs-are-marked-crashed
