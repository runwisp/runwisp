...
It proves the generated tasks are valid. What it can't prove is that they merge
cleanly with the tasks you already have, since that means writing the files and
loading the result — the real run does that, and rolls back if it fails.
