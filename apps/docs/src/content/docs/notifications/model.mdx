...
sign up for. Unplug the network on a laptop and a failed task *still*
...
Every id in this list gets *added* to whatever channels a task already
...
You *can* still route `notify.delivery_failed` somewhere else — the
