...
| `keep_runs`        | _(unset)_    | Default row-count retention. Positive integer; hard internal cap of 1 000 000. Zero means "inherit from task-level setting" — only negatives are rejected.                                                                                       |
