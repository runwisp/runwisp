...
- **Dark mode in the Web UI.** A theme switch in the header lets you pick **Auto**, **Light**, or **Dark** — Auto follows your operating system and updates live when the OS flips between day and night. Your choice is remembered and applied before the page paints, so there's no flash of the wrong theme on load.
