...
export const inboundDaemonMessageSchema = z.discriminatedUnion("type", [
  ...
  z.object({ "type": z.literal("log:line"), "protocolVersion": z.literal(PROTOCOL_VERSION).optional(), "sentAt": z.string().optional(), "executionId": z.string(), "n": z.number().int(), "ts": z.number().int().optional(), "stream": z.enum(["stdout", "stderr", "system"]), "text": z.string(), "continued": z.boolean().optional() }),
