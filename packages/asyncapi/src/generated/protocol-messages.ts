...
export const inboundDaemonMessageSchema = z.discriminatedUnion("type", [
  ...
  z.object({ "type": z.literal("log:replayChunk"), "v": z.literal(PROTOCOL_VERSION).optional(), "sentAt": z.string().optional(), "requestId": z.string(), "executionId": z.string(), "lines": z.unknown(), "final": z.boolean() }),
  z.object({ "type": z.literal("log:searchChunk"), "v": z.literal(PROTOCOL_VERSION).optional(), "sentAt": z.string().optional(), "requestId": z.string(), "executionId": z.string(), "hits": z.unknown(), "nextLine": z.number().int().optional(), "exhausted": z.boolean() }),
...
export const outboundDaemonMessageSchema = z.discriminatedUnion("type", [
  ...
  z.object({ "type": z.literal("log:replayRequest"), "v": z.literal(PROTOCOL_VERSION).optional(), "sentAt": z.string().optional(), "requestId": z.string(), "executionId": z.string(), "fromLine": z.number().int(), "limit": z.number().int().nonnegative() }),
  z.object({ "type": z.literal("log:searchRequest"), "v": z.literal(PROTOCOL_VERSION).optional(), "sentAt": z.string().optional(), "requestId": z.string(), "executionId": z.string(), "query": z.string(), "regex": z.boolean().optional(), "caseSensitive": z.boolean().optional(), "limit": z.number().int().nonnegative().optional(), "fromLine": z.number().int().optional() }),
